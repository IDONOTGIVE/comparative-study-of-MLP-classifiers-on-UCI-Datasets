function [Whidden, Wout] = Backpropagation_SM(train_features, train_targets, params)
...
% This function was revised from Backpropagation_SM 
% in the book "Computer Manual in MATLAB to accompany Pattern Classification"
% by Bailing Zhang, Oct 2010

[Nh, No,Theta, alpha, eta] = process_params(params);
iter	= 0;
